...
namespace Api.Service.Test.Municipio
{
    public class QuandoForExecutadoCreate : MunicipioTestes
    {
        ...
        public async Task E_Possivel_Executar_Metodo_Create()
        {
            ...
            Assert.Equal(municipioDtoCreate.Nome, result.Nome);
            Assert.Equal(municipioDtoCreate.CodIbge, result.CodIbge);
            Assert.Equal(municipioDtoCreate.ufId, result.ufId);
        }
    }
}
